...
public interface ICoordinateSystem extends IInfo {
     ...
     */
    int getDimension() throws Exception;
     ...
     * @throws Exception the exception
     */
    AxisInfo getAxis(int dimension) throws Exception;
     ...
     * @throws Exception the exception
     */
    IUnit getUnits(int dimension) throws Exception;
     ...
     * @throws Exception the exception
     */
    double[] getDefaultEnvelope() throws Exception;
